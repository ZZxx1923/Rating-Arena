    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-3 px-4 py-5 border-b" style={{ borderColor: "oklch(1 0 0 / 0.06)" }}>
        <div
          ...
          style={{ background: "oklch(0.60 0.22 264 / 0.2)", border: "1px solid oklch(0.60 0.22 264 / 0.3)" }}
        >
          <img
        ...
        <div>
          <p className="font-bold text-sm" style={{ fontFamily: "'Sora', sans-serif", color: "var(--foreground)" }}>
            EvalPro
          </p>
          <p className="text-xs" style={{ color: "oklch(0.55 0.015 264)" }}>
